...
abc2svg.Abc = function (user) {
    ...
    function d_upstaff(de) {
        ...
        switch (dd.glyph) {
            case "brth": case "caes": case "lphr": case "mphr": case "sphr": case "short": case "tick": y = stafft
                if (s.type == C.BAR) { s.invis = 1 } else {
    ...
    function deco_def(nm, nmd) {
        ...
        if (str) {
            if (str[0] == '"')
                str = str.slice(1, -1); if (str[0] == '@' && !str.match(/^@([0-9.-]+),([0-9.-]+);?/)) {
    ...
    function deco_width(s) {
        var dd, i, w, wl = 0, a_dd = s.a_dd, nd = a_dd.length
        for (i = 0; i < nd; i++) {
            dd = a_dd[i]
            switch (dd.func) {
                case 1: if (wl < 7)
    ...
    function draw_deco_staff() {
        var s, p_voice, y, i, v, de, dd, minmax = new Array(nstaff + 1), nd = a_de.length
        function draw_repbra(p_voice) {
            ...
            for (s = p_voice.sym; s; s = s.next) {
                ...
                if (s1.text) {
                    wh = strwh(s1.text); y2 = y_get(p_voice.st, true, s1.x + 4, wh[0]) +
                        wh[1]
                    if (y < y2)
                        y = y2
                }
    ...
    function draw_partempo(st, top) {
        var s, s2, some_part, some_tempo, h, w, y, dy = 0, ht = 0
    ...
    function draw_beams(bm) {
        var s, i, beam_dir, shift, bshift, bstub, bh, da, bd, k, k1, k2, x1, s1 = bm.s1, s2 = bm.s2
...
<text x="X" y="Y" text-anchor="middle">A</text>\n', x, y + 12, m_gl(meter.top))
    ...
    function draw_slur(path, sl) {
        var i, k, g, x1, y1, x2, y2, height, addy, a, y, z, h, dx, dy, ty = sl.ty, dir = (ty & 0x07) == C.SL_ABOVE ? 1 : -1, n = path.length, i1 = 0, i2 = n - 1, not1 = sl.nts, k1 = path[0], k2 = path[i2]
    ...
    function set_staff() {
        var i, st, prev_staff, v, y, staffsep, dy, maxsep, mbot, val, p_voice, p_staff, fmt = tsfirst.fmt, sy = cur_sy
        for (v = 0; v < voice_tb.length; v++) {
            p_voice = voice_tb[v]
            if (p_voice.scale != 1)
    ...
    function draw_systems(indent) {
        ...
        function draw_staff(st, x1, x2) {
            ...
            if (cache && cache.st_l == stafflines && cache.st_w == (w | 0)) {
...
H "History: "', infospace: 0, keywarn: true, leftmargin: 0.2 * CM, lineskipfac: 1.1, linewarn: true, maxshrink: .65, maxstaffsep: 2000, maxsysstaffsep: 2000, measrepnb: 1, measurefont: { name: txt_ff, style: "italic", size: 10 }, measurenb: -1, musicfont: { name: "music", src: musicfont, size: 24 }, musicspace: 6, partsfont: { name: txt_ff, size: 15 }, parskipfac: .4, partsspace: 8, pagewidth: PageWidth, "propagate-accidentals": "o", printmargin: 0, rightmargin: 0.2 * CM, rbmax: 4, rbmin: 2, repeatfont: { name: txt_ff, size: 9 }, scale: 1, slurheight: 1.0, spatab: new Float32Array([10.2, 13.3, 17.3, 22.48, 29.2, 38, 49.4, 64.2, 83.5, 108.5]), staffsep: 46, stemheight: 21, stretchlast: .25, stretchstaff: true, subtitlefont: { name: txt_ff, size: 16 }, subtitlespace: 3, sysstaffsep: 34, tempofont: { name: txt_ff, weight: "bold", size: 12 }, textfont: { name: txt_ff, size: 16 }, textspace: 14, tieheight: 1.0, titlefont: { name: txt_ff, size: 20 }, titlespace: 6, titletrim: true, topspace: 22, tuplets: [0, 0, 0, 0], tupletfont: { name: txt_ff, style: "italic", size: 12 }, vocalfont: { name: txt_ff, weight: "bold", size: 13 }, vocalspace: 10, voicefont: { name: txt_ff, weight: "bold", size: 13 }, writefields: "CMOPQsTWw", wordsfont: { name: txt_ff, size: 16 }, wordsspace: 5, "writeout-accidentals": "n"
    ...
    function param_set_font(xxxfont, p) {
        ...
        font = cfmt[xxxfont]; if (!font) { font = { pad: 0 } } else { font = { name: font.name, size: font.size, weight: font.weight, style: font.style, box: font.box, pad: font.pad || 0 } }
    ...
    Abc.prototype.set_format = function (cmd, param) {
        ...
        switch (cmd) {
            case "aligncomposer": case "barsperstaff": case "infoline": case "measurenb": case "rbmax": case "rbmin": case "measrepnb": case "shiftunison": v = parseInt(param)
            ...
            case "textoption": cfmt[cmd] = get_textopt(param)
                break
            case "dynalign": case "singleline": case "stretchlast": case "titletrim": v = +param
                if (isNaN(v))
 ...
 src:"+ font.src + "}")
    ...
    function set_allsymwidth(first) {
        ...
        while (1) {
            ...
            if (!s2.shrink) { if (!s2.space && s2.type == C.CLEF && !s2.ts_prev.bar_type) { delete s2.seqst; s2.time = tim } else if (s2.dur) { s2.shrink = 10 } }
            tim = s2.time
            if (!s)
                break
    ...
    function set_nl(s) {
        ...
        function bardiv(so) {
            ...
            for (s = so; ; s = s.ts_next) {
                switch (s.type) { case C.KEY: case C.METER: case C.CLEF: continue }
                break
            }
            while (s1 != so) {
            ...
            if (s.type == C.BLOCK) {
                switch (s.subtype) {
                    ...
                    case "mc_start": mc = { lm: cfmt.leftmargin, rm: cfmt.rightmargin }
                        break
                    case "mc_new": case "mc_end": cfmt.leftmargin = mc.lm
    ...
    function set_ottava() {
        ...
        function ottava_add(s, ottava, start) {
            var dc_st = ["15mb(", "8vb(", null, "8va(", "15ma("], dc_en = ["15mb)", "8vb)", null, "8va)", "15ma)"]; a_dcn.push((start ? dc_st : dc_en)[2 + ottava])
            deco_cnv(s)
        }
    ...
    var rest_sp = [[18, 18], [12, 18], [12, 12], [6, 12], [6, 8], [10, 10], [6, 4], [10, 0], [10, 4], [10, 10]]
    ...
    function init_music_line() {
        ...
        s.seqst = true
        for (s = last_s; s.ts_next && !s.ts_next.seqst; s = s.ts_next); s2 = s.ts_next
        s.ts_next = null
        set_allsymwidth()
        s.ts_next = s2
    }
    ...
    function get_lshift() {
        var st, v, p_v, p1, po, fnt, w, lsh1 = 0, lsho = 0, nv = voice_tb.length
    ...
    function set_indent(lsh) {
        var st, v, w, p_voice, p, i, j, font, vnt = 0, nv = voice_tb.length
        for (v = 0; v < nv; v++) {
            p_voice = voice_tb[v]
    ...
    Abc.prototype.block_gen = function (s) {
        switch (s.subtype) {
            case "leftmargin": case "rightmargin": case "pagescale": case "pagewidth": case "scale": case "staffwidth": self.set_format(s.subtype, s.param)
                break
            case "mc_start": multicol = { posy: posy, maxy: posy, lm: cfmt.leftmargin, rm: cfmt.rightmargin, w: cfmt.pagewidth, sc: cfmt.scale }
                break
            case "mc_new": if (posy > multicol.maxy)
                multicol.maxy = posy
                ...
                img.chg = 1
                break
            case "mc_end": if (posy < multicol.maxy)
                posy = multicol.maxy
                cfmt.leftmargin = multicol.lm
                cfmt.rightmargin = multicol.rm
                cfmt.pagewidth = multicol.w
        ...
        if (tsnext) {
            ...
            for (v = 0; v < nv; v++) {
                ...
                if (p_voice.sym && p_voice.sym.time <= tsnext.time) {
                    for (s = tsnext.ts_prev; s; s = s.ts_prev) { if (s.v == v) { p_voice.s_next = s.next; s.next = null; break } }
                    if (s)
                        continue
                }
    ...
    Abc.prototype.set_sym_glue = function (width) {
        var s, g, ll, x, some_grace, spf, xmin = 0, xx = 0, xs = 0, xse = 0
        for (s = tsfirst; s; s = s.ts_next) {
    ...
    function new_bar() {
        ...
        if (s.rbstart && curvoice.norepbra && !curvoice.second)
            s.norepbra = true
        if (curvoice.ulen < 0)
            adjust_dur(s); if (bar_type == "[" || bar_type == "|:") {
    ...
    function set_map(note, acc) {
        var pit = note.pit, nn = not2abc(pit, acc), map = maps[curvoice.map]
        if (!map[nn]) {
            nn = 'o' + nn.replace(/[',]+/, '')
            if (!map[nn]) {
                nn = 'k' + ntb[(pit + 75 -
    ...
    function write_headform(lwidth) {
        var c, font, font_name, align, x, y, sz, w, info_val = {}, info_font = Object.create(info_font_init), info_sz = { A: cfmt.infospace, C: cfmt.composerspace, O: cfmt.composerspace, R: cfmt.infospace }, info_nb = {}
...
<tspan dy=".5" style="font-size:10px">mb</tspan></text>\n', x - 10, y); x += 18
 ...
 fill="currentColor" stroke-width=".7"', g = ''
    ...
    function sort_all() {
        var s, s2, time, w, wmin, ir, fmt, fl, new_sy, nv = voice_tb.length, vtb = [], vn = [], sy = cur_sy, v = sy.top_voice, p_voice = voice_tb[v], prev = { type: C.STAVES, dur: 0, v: v, p_v: p_voice, time: 0, st: 0, sy: sy, next: p_voice.sym, seqst: true }
        if (!p_voice.sym)
            return
        ...
        while (1) {
            ...
            while (1) {
                ...
                if (!s || s.time != time || w_tb[s.type] != wmin)
                    continue
                if (s.type == C.STAVES) { new_sy = s.sy } else if (s.type == C.SM) {
                    s.next.prev = s.prev
                    if (s.prev)
                        s.prev.next = s.next
                    else
    ...
    function voice_adj(sys_chg) {
        ...
        for (v = 0; v < voice_tb.length; v++) {
            ...
            for (; s; s = s.next) {
                if ((((!w_tb[s.type] && s.type != C.STAVES) || s.type == C.SPACE) && s.time && (!s.prev || s.time > s.prev.time + s.prev.dur)) || (s.type == C.GRACE && s.prev && s.prev.type == C.GRACE)) {
                    s2 = { type: C.SM, v: s.v, p_v: s.p_v, time: s.time, dur: 0, next: s, prev: s.prev, fmt: s.fmt }
                    if (s.prev)
                        s.prev.next = s2
                    else
                        voice_tb[s.v].sym = s2
    ...
    Abc.prototype.set_bar_num = function () {
        ...
        for (; s; s = s.ts_next) {
            switch (s.type) {
                case C.METER: if (s.time == bar_tim)
                    break
                    if (wmeasure != 1)
    ...
    function set_transp() {
        ...
        if (cfmt.transp && curvoice.shift)
            syntax(0, "Mix of old and new transposition syntaxes"); if (is_voice_sig()) {
    ...
    function key_transp(s) {
        if (s.k_none)
            return
        var n, a_acc, b40 = (s.k_b40 + 200 + curvoice.tr_sco) % 40, d = abc2svg.b40k[b40] - b40
        if (d) {
        ...
        for (n = 0; n < s.k_a_acc.length; n++) {
            ...
            + curvoice.tr_sco
            a_acc[n] = { pit: abc2svg.b40p(b40), acc: abc2svg.b40a(b40) || 3 }
        }
        s.k_a_acc = a_acc
    }
    ...
    function get_clef(s) {
        ...
        var s2 = s.prev
        if (!s.invis && s2 && s2.type == C.BAR && s2.bar_type[0] != ':') {
            s.next = s2
            s.prev = s2.prev
            if (s.prev)
                s.prev.next = s
    ...
    function get_key(parm) {
        var v, p_voice, transp, sndtran, tr_p, nt, a = new_key(parm), s_key = a[0], s = s_key
        a = a[1]
        if (parse.state == 1) {
            ...
            parse.ckey = s_key
            if (!glovar.ulen)
                glovar.ulen = C.BLEN / 8; if (a.length) {
                    memo_kv_parm('*', a)
                    a = ''
                }
            goto_tune()
        ...
        if (n == 1 && p_voice.default) {
            ...
            if (!p_voice.time) {
                ...
                if (cfmt.transp && parse.state >= 2) {
                    p_v_sav = curvoice; curvoice = p_voice; curvoice.tr_sco = cfmt.transp
                    set_transp(); curvoice = p_v_sav
                }
                return p_voice
            }
        }
    ...
    function do_cloning() {
        var i, clone = curvoice.clone, vs = clone.vs, a = clone.a, bol = clone.bol, eol = parse.istart, parse_sav = parse, file = parse.file
    ...
    function goto_tune() {
        var v, p_voice
        set_page(); write_heading(); if (glovar.new_nbar) {
    ...
    function gch_tr1(p) {
        var i, o, n, a, ip, b40, tr = curvoice.tr_sco, csa = p.split('/')
    ...
    function draw_all_chsy() {
        var s, san1, an, i, y, w, n_an = 0, minmax = new Array(nstaff + 1)
    ...
    Abc.prototype.add_style = function (s) { style += s }; Abc.prototype.cfmt = function () { return cfmt }; Abc.prototype.clone = clone; Abc.prototype.deco_put = function (nm, s) {
        a_dcn.push(nm)
        deco_cnv(s)
    }
...
abc2svg.modules = {
    ambitus: {}, begingrid: { fn: 'grid3' }, beginps: { fn: 'psvg' }, break: {}, capo: {}, chordnames: {}, clip: {}, clairnote: { fn: 'clair' }, voicecombine: { fn: 'combine' }, diagram: { fn: 'diag' }, equalbars: {}, gamelan: {}, grid: {}, grid2: {}, jazzchord: {}, jianpu: {}, mdnn: {}, MIDI: {}, nns: {}, pageheight: { fn: 'page' }, pedline: {}, percmap: { fn: 'perc' }, roman: {}, soloffs: {}, sth: {}, strtab: {}, temperament: { fn: 'temper' }, tropt: {}, nreq: 0, hooks: [], g_hooks: [], load: function (file, relay, errmsg) {
        function get_errmsg() {
...
abc2svg.version = "v1.22.5-32-cc56aa182c"; abc2svg.vdate = "2022-12-26"
