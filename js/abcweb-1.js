...
<div class="source">\n'
    ...
    if (!abc2svg.Abc) {
        abc2svg.loadjs(src.indexOf("<mei ") >= 0 ? "mei2svg-1.js" : "abc2svg-1.js", dom_loaded)
        return
    }
    ...
    if (abc2svg.music[0].t) {
        abc.tosvg(abc2svg.music[0].n, abc2svg.music[0].t)
        if (abc.cfmt().with_source && abc.cfmt().with_source.indexOf('nohead') < 0) {
