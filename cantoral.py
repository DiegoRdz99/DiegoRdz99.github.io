...
class constants:
    def __init__(self,backsteps,title=''):
        ...
        self.html_footer = f'''
        <br><br><br><br>
        <div class="btn-group btn-group-lg fixed-bottom mx-auto shadow toolbar" style="width:70%;" role="group" aria-label="Basic example">
            ...
            <button type="button" class="btn btn-dark" onclick="startInverval()"><span class="icon">Scroll</span></button>
            <button type="button" class="btn btn-dark" onclick="toggleDark()"><span class="icon">Dark</span></button>
