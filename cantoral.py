...
class constants:
    def __init__(self,backsteps,title=''):
        ...
        <div class="btn-group btn-group-lg fixed-bottom mx-auto shadow toolbar" style="width:70%;" role="group" aria-label="Basic example">
            ...
            <button type="button" class="btn btn-dark" onclick="startInverval()"><span class="icon">&#9654;</span></button>
            <button type="button" class="btn btn-dark" onclick="toggleDark()"><span class="icon">Dk</span></button>
